...
epoch_settings = {'epoch mode': 'same population', 'max repeat': 1, 'epoch first energy fitness function': False}
...
predation_information_DCM_PD1 = {'Predation Operator': 'IDCM', 'percentage_diff': 1.0}
...
fitness_information_SCM_rCut_half = {'Fitness Operator': 'SCM + Energy', 'SCM Scheme': 'T-SCM', 'rCut': rCut_half, 'SCM_fitness_contribution': 0.5, 'normalise_similarities': False, 'Dynamic Mode': False, 'energy_fitness_function': energy_fitness_function_exp, 'SCM_fitness_function': SCM_fitness_function}
fitness_information_SCM_rCut_half_0_8 = {'Fitness Operator': 'SCM + Energy', 'SCM Scheme': 'T-SCM', 'rCut': rCut_half, 'SCM_fitness_contribution': 0.8, 'normalise_similarities': False, 'Dynamic Mode': False, 'energy_fitness_function': energy_fitness_function_exp, 'SCM_fitness_function': SCM_fitness_function}
# ------------------------------------------------------------------------------------------------------------ #
...
print_details = True
no_of_cpus = 4
finish_algorithm_if_found_cluster_energy = {'cluster energy': -543.67, 'round': 2}
...
Runs.append(('D_Energy_F_Energy_exp',predation_information_Energy_energy,fitness_information_energy_exp))
Runs.append(('D_DCM_PD1_F_Energy_exp',predation_information_DCM_PD1,fitness_information_energy_exp))
Runs.append(('D_DCM_PD2_F_Energy_exp',predation_information_DCM_PD2,fitness_information_energy_exp))
...
Runs.append(('D_Energy_F_SCM_1_rCut',predation_information_Energy_energy,fitness_information_SCM_rCut_half))
...
Runs.append(('D_Energy_F_SCM_1_rCut_scm_co_0_8',predation_information_Energy_energy,fitness_information_SCM_rCut_half_0_8))
