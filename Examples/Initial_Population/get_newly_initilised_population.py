from GetNewlyInitilisedPopulation import GetNewlyInitilisedPopulation
###############################################################################################################################################
...
#Diversity_Information = {'Diversity_Switch':'Energy Diversity', 'energy_diversity_mode': 'simple', 'round_energy': 6}
Diversity_Information = {'Diversity_Switch':'Energy Diversity', 'energy_diversity_mode': 'comprehensive', 'minimum_energy_diff': (10.0)**(-2.0)}
#Diversity_Information = {'Diversity_Switch':'Energy Diversity', 'energy_diversity_mode': 'comprehensive', 'minimum_energy_diff': (10.0)**(-6.0)}
