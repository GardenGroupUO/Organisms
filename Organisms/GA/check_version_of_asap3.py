...
def check_version_of_asap3():
	"""
	This method will check that you has the asap3 package, and that it is the correct version (3.11.10)
	"""

	# First, check that you have asap3
	...
	# Second, check that you are using asap3 version 3.11.10
	import asap3
