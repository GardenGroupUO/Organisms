...
# def GA_Program_Logo_not_coloured():
# 	"""
...
def GA_Program_Logo_coloured(colored):
	"""
	Provides the opening logo for the Organisms program.
	"""
	print("")
...
def default_color(input_string,color):
	return input_string
...
def GA_Program_Logo():
	try:
		...
		if not (termcolor_spec is None):
			from termcolor import colored
		else:
			colored = default_color
	except Exception:
		colored = default_color
	GA_Program_Logo_coloured(colored)
