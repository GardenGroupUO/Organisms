...
class Energy_Fitness_Operator(Fitness_Operator):
	...
	############################################################################################################
	################## Method for assign_all_fitnesses_before_assessing_against_predation_operator ##################
	############################################################################################################

	def assign_all_fitnesses_before_assessing_against_predation_operator(self,all_offspring_pools,current_generation_no):
		"""
	...
	###########################################################################################################
	################## Method for assign_all_fitnesses_after_assessing_against_predation_operator ##################
	###########################################################################################################

	def assign_all_fitnesses_after_assessing_against_predation_operator(self,all_offspring_pools,current_generation_no, offspring_to_remove):
		"""
		This method is to be used in the GA program. 
