...
def get_SCM_methods(SCM_Scheme):
	...
	"""
	if SCM_Scheme == 'A-SCM':
		from Organisms.GA.SCM_Scripts.A_SCM_Methods import get_single_atomic_CNA_profile_method as get_single_CNA_profile_method
		from Organisms.GA.SCM_Scripts.A_SCM_Methods import get_CNA_similarities
	elif SCM_Scheme == 'T-SCM':
		from Organisms.GA.SCM_Scripts.T_SCM_Methods import get_single_total_CNA_profile_method  as get_single_CNA_profile_method
		from Organisms.GA.SCM_Scripts.T_SCM_Methods import get_CNA_similarities
	else:
		...
		exit()
	return get_single_CNA_profile_method, get_CNA_similarities
