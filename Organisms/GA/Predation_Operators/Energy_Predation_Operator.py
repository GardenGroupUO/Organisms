...
class Energy_Predation_Operator(Predation_Operator):
	...
	def get_energy_predation_methods(self):
		...
		"""
		if self.mode == 'simple':
			from Organisms.GA.Predation_Operators.Energy_Predation_Operator_Scripts.Simple_Energy_Predation_Operator import check_initial_population, assess_for_violations
		elif self.mode == 'comprehensive':
