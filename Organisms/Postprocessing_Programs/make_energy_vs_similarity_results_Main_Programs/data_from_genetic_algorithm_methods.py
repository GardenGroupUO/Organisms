from Organisms.GA.SCM_Scripts.T_SCM_Methods   import get_single_total_CNA_profile_method, get_CNA_similarities
...
def get_CNA_Profile_custom(cluster_to_compare_against,rCut):
	...
	name, CNA_profile = get_CNA_profile(input_data, get_single_CNA_method=get_single_total_CNA_profile_method, no_of_cpus=1)
	return CNA_profile
