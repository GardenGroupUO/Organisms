...
def perform_animations(Population_Per_generation, Offspring_Per_generation, cluster_folder_path, gps=1, max_time=None, label_no_of_epochs=False):
...
def perform_animations_no_offspring(Population_Per_generation, cluster_folder_path, gps=1, max_time=None, label_no_of_epochs=False):
	print('============================== MAKING PLOTTING ANIMATIONS ================================================')
